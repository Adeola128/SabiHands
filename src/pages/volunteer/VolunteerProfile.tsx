      ...
      <div style={{ maxWidth: '1200px', margin: '40px auto 0', display: 'grid', gridTemplateColumns: '1fr 380px', gap: '32px', padding: '0 24px', alignItems: 'start' }} className="responsive-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="premium-card">
            <h2 className="premium-card-title">Professional Background</h2>
            <p style={{ fontSize: '16px', color: 'var(--body)', lineHeight: 1.7, margin: 0, whiteSpace: 'pre-line' }}>
              {profile?.bio || 'No professional background provided.'}
            </p>
          </div>

          {profile?.motivation && (
            <div className="premium-card">
              <h2 className="premium-card-title">Why I Volunteer</h2>
              <p style={{ fontSize: '16px', color: 'var(--body)', lineHeight: 1.7, margin: 0, whiteSpace: 'pre-line' }}>
                {profile.motivation}
              </p>
            </div>
          ...
          {profile?.education && (
            <div className="premium-card">
              <h2 className="premium-card-title">Education & Qualifications</h2>
              <p style={{ fontSize: '16px', color: 'var(--body)', lineHeight: 1.7, margin: 0, whiteSpace: 'pre-line' }}>
                {profile.education}
              </p>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          {(profile?.linkedin_url || profile?.portfolio_url || profile?.resume_url) && (
            <div className="premium-card">
              <h2 className="premium-card-title">Links & Documents</h2>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {profile?.resume_url && (
                  <a href={profile.resume_url} target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--purple-600)', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                    Resume / CV
                  </a>
                )}
                {profile?.linkedin_url && (
                  <a href={profile.linkedin_url} target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--purple-600)', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>
                ...
                {profile?.portfolio_url && (
                  <a href={profile.portfolio_url} target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--purple-600)', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>
