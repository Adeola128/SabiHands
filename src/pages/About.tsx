    ...
    <div className="about-page">
      <header className="about-hero">
        ...
        >
          ...
          <p className="about-lede">We believe that showing up should count for something. Gigway was built to turn real gigs into real proof.</p>
        </motion.div>
      </header>
      ...
      <div className="about-content">
        ...
        >
          ...
          <p>Gigway bridges this gap. We've built a marketplace where organizations can post gigs in minutes, and volunteers can show up, get the job done, and walk away with a verifiable certificate that proves they actually did the work. No CV needed to start, and no chasing anyone down for a signature afterward.</p>
        </motion.section>
        ...
        >
          ...
          <p>If we can make Gigway the definitive home for showing up in Lagos, the rest of the continent will follow.</p>
        </motion.section>
        ...
        >
          ...
          <div className="founder-card">
            ...
            <div className="founder-info">
              ...
              <p>After running dozens of community beach cleanups and seeing the same talented, unemployed youth showing up every weekend, Adeola realized the fundamental problem wasn't a lack of driveâ€”it was a lack of proof. She built Gigway so that every time someone steps up to help, it adds to a resume that employers actually trust.</p>
            </div>
          </div>
        </motion.section>
      </div>
