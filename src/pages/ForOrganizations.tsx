    ...
    <div className="role-page org-theme">
      <header className="role-hero">
        ...
        >
          ...
          <p className="role-lede">Stop managing volunteers through messy WhatsApp groups. Post a gig, find verified local talent, and let Gigway handle the certificates automatically.</p>
        ...
        <div className="wrap">
          ...
          >
            ...
            <motion.div className="feature-card" variants={fadeUpVariant}>
              ...
              <p>Review applicants based on their Gigway track record and past completed certificates.</p>
            </motion.div>
            <motion.div className="feature-card" variants={fadeUpVariant}>
