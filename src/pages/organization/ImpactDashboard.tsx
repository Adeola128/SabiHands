        ...
        <div className="dash-card">
          <div className="dash-card-padding">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                { skill: 'Writing', pct: 40 },
                { skill: 'Event Setup', pct: 25 },
                { skill: 'Teaching', pct: 20 },
                { skill: 'Web Dev', pct: 15 },
              ].map(s => (
                <div key={s.skill}>
                  ...
                  <div style={{ height: '6px', backgroundColor: 'var(--paper)', borderRadius: '99px', overflow: 'hidden' }}>
                    <div style={{ height: '100%', width: `${s.pct}%`, backgroundColor: 'var(--teal-600)', borderRadius: '99px' }} />
                  </div>
                </div>
              ))}
            </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '24px' }}>
          ...
          <div className="dash-card">
            <div className="dash-card-padding" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              ...
              <div>
                <div style={{ fontSize: '32px', fontWeight: 700, color: 'var(--ink)', fontFamily: 'var(--display)', lineHeight: 1 }}>12</div>
          ...
          <div className="dash-card">
            <div className="dash-card-padding" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              ...
              <div>
                <div style={{ fontSize: '32px', fontWeight: 700, color: 'var(--ink)', fontFamily: 'var(--display)', lineHeight: 1 }}>84</div>
          ...
          <div className="dash-card">
            <div className="dash-card-padding" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              ...
              <div>
                <div style={{ fontSize: '32px', fontWeight: 700, color: 'var(--ink)', fontFamily: 'var(--display)', lineHeight: 1 }}>320</div>
          ...
          <div className="dash-card">
            <div className="dash-card-padding" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              ...
              <div>
                <div style={{ fontSize: '32px', fontWeight: 700, color: 'var(--ink)', fontFamily: 'var(--display)', lineHeight: 1 }}>76</div>
        ...
        <div className="dash-card" style={{ background: 'linear-gradient(135deg, var(--teal-900) 0%, var(--teal-600) 100%)', color: 'white', marginBottom: '24px' }}>
          <div className="dash-card-padding" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              ...
              <div style={{ fontSize: '48px', fontFamily: 'var(--display)', fontWeight: 700, lineHeight: 1 }}>₦1,450,000</div>
              <p style={{ fontSize: '14px', color: 'var(--teal-50)', marginTop: '8px', opacity: 0.9 }}>Based on average hourly rates for skills provided by your volunteers.</p>
            </div>
