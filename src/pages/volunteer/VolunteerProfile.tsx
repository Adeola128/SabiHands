        ...
        <div>
          ...
          <div className="vol-card">
            ...
            <div className="vol-cert-mini">
              ...
              <div>
                <div style={{ fontSize: '14px', fontWeight: 700, color: 'var(--ink)' }}>First Gig Completed</div>
                <div style={{ fontSize: '13px', color: 'var(--muted)', marginTop: '2px' }}>SabiHands Platform</div>
              </div>
            </div>
          </div>
        </div>
