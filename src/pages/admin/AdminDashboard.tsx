          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start', paddingBottom: '16px', borderBottom: '1px solid #F1F5F9' }}>
              ...
              <div>
                ...
                <button onClick={() => window.location.href = '/hq/org-verification'} style={{ background: '#F1F5F9', border: 'none', padding: '6px 12px', borderRadius: '6px', fontSize: '12px', fontWeight: 600, color: '#334155', cursor: 'pointer' }}>Review Queue</button>
              </div>
            </div>
          </div>
        </div>
