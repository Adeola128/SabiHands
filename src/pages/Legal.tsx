    ...
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        >
          {isTerms ? (
            <>
              <p>Welcome to Ralvo. These Terms of Service govern your use of the Ralvo platform, including both the volunteer application and the organization dashboard.</p>
            ...
            <>
              <p>Your privacy is important to us. This Privacy Policy explains how Ralvo collects, uses, and shares your personal information.</p>
